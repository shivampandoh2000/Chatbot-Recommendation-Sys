...
bot=ChatBot('Main_Bot',read_only=True,
            ...
            {'import_path':'chatterbot.logic.SpecificResponseAdapter',
             'input_text':'Hi',
             'output_text':'Hi there'
             }],database_uri='mongodb://localhost:27017/db21'
    )

trainer=ListTrainer(bot)


for files in os.listdir('/home/shivam007/cht_bot/dbses/dses_2/'):
    data=open('/home/shivam007/cht_bot/dbses/dses_2/' + files ,'r').readlines()
    trainer.train(data)

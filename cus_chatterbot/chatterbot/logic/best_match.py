...
class BestMatch(LogicAdapter):
    ...
    def process(self, input_statement, additional_response_selection_parameters=None):
        ...
        self.chatbot.logger.info('Using "{}" as a close match to "{}" with a confidence of {}'.format(
            closest_match.Solution, input_statement.Solution, closest_match.confidence
        ))
        ...
        if response_list:
            ...
            self.chatbot.logger.info('Response selected. Using "{}"'.format(response.Solution))
            ...
            response.confidence = closest_match.confidence
            self.chatbot.logger.info('Alternate response selected. Using "{}"'.format(response.Solution))
        else:

    ...
    def _generate_export_data(self):
        ...
        for statement in self.chatbot.storage.filter():
            if statement.question:
                result.append([statement.question, statement.Solution])
        ...
        for conversation_count, text in enumerate(conversation):
            ...
            statement = self.get_preprocessed_statement(
                Statement(
                    ...
                    question=previous_statement_text,
                    search_in_response_to=previous_statement_search_text,
                    conversation='training'
                )
            )

            previous_statement_text = statement.Solution
                ...
                with open(tsv_file, 'r', encoding='utf-8') as tsv:
                    ...
                    for row in reader:
                        if len(row) > 0:
                            ...
                            statement.search_text = tagger.get_text_index_string(statement.Solution)

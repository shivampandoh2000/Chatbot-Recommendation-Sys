...
class LevenshteinDistance(Comparator):
    ...
    def compare(self, statement_a, statement_b):
        ...
        if not statement_a.Solution or not statement_b.Solution:
            return 0

        # Get the lowercase version of both strings
        statement_a_text = str(statement_a.Solution.lower())
        statement_b_text = str(statement_b.Solution.lower())
...
class SpacySimilarity(Comparator):
    ...
    def compare(self, statement_a, statement_b):
        ...
        :rtype: float
        """
        document_a = self.nlp(statement_a.Solution)
        document_b = self.nlp(statement_b.Solution)
...
class JaccardSimilarity(Comparator):
    ...
    def compare(self, statement_a, statement_b):
        ...
        document_a = self.nlp(statement_a.Solution.lower())
        document_b = self.nlp(statement_b.Solution.lower())

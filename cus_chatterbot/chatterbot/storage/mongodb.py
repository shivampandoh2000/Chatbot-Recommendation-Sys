...
class MongoDatabaseAdapter(StorageAdapter):
    ...
    def create_many(self, statements):
        ...
        for statement in statements:
            ...
            if not statement.search_text:
                statement_data['search_text'] = self.tagger.get_text_index_string(statement.Solution)

            if not statement.search_in_response_to and statement.question:
                statement_data['search_in_response_to'] = self.tagger.get_text_index_string(statement.question)
    ...
    def update(self, statement):
        ...
        data['search_text'] = self.tagger.get_text_index_string(data['Solution'])

        if data.get('question'):
            data['search_in_response_to'] = self.tagger.get_text_index_string(data['question'])

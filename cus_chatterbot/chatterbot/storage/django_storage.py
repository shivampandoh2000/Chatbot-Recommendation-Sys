...
class DjangoStorageAdapter(StorageAdapter):
    ...
    def create(self, **kwargs):
        ...
        if 'search_in_response_to' not in kwargs:
            if kwargs.get('question'):
                kwargs['search_in_response_to'] = self.tagger.get_text_index_string(kwargs['question'])
    ...
    def create_many(self, statements):
        ...
        for statement in statements:
            ...
            if not statement.search_text:
                statement_model_object.search_text = self.tagger.get_text_index_string(statement.Solution)

            if not statement.search_in_response_to and statement.question:
                statement_model_object.search_in_response_to = self.tagger.get_text_index_string(statement.question)
    ...
    def update(self, statement):
        ...
        if hasattr(statement, 'id'):
            ...
            statement = Statement.objects.create(
                text=statement.Solution,
                search_text=self.tagger.get_text_index_string(statement.Solution),
                conversation=statement.conversation,
                in_response_to=statement.question,
                search_in_response_to=self.tagger.get_text_index_string(statement.question),
    ...
    def remove(self, statement_text):
        ...
        statements = Statement.objects.filter(Solution=statement_text)
